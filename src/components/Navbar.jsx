        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <span className="text-[#EAE7DF] font-serif text-xl tracking-widest uppercase hidden sm:block">
              Sovereign <span className="text-[#8B6B3E]/60 font-light">Trader</span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-10">
            {navItems.map((item) => (
              <Link
                ...
                className={`text-[10px] uppercase tracking-[0.3em] font-bold transition-colors duration-300 ${
                  location.pathname === item.path ? 'text-[#8B6B3E]' : 'text-[#EAE7DF]/60 hover:text-[#8B6B3E]'
                }`}
              >
                {item.name}
              </Link>
            ...
            {user ? (
              <div className="flex items-center space-x-6 pl-6 border-l border-[#8B6B3E]/20">
                <Link to="/dashboard" className="text-[#8B6B3E] hover:text-[#EAE7DF] transition-colors">
              ...
              <Link to="/login" className="pl-6 border-l border-[#8B6B3E]/20">
              ...
              <div className="pt-6 border-t border-[#8B6B3E]/10">
                {user ? (
                  <div className="flex items-center space-x-8">
                    <Link to="/dashboard" onClick={() => setIsOpen(false)} className="text-[#8B6B3E] uppercase tracking-widest text-[10px] font-bold">
                      Dashboard
                    </Link>
                  ...
                  <Link to="/login" onClick={() => setIsOpen(false)} className="text-[#8B6B3E] uppercase tracking-widest text-[10px] font-bold">
                    Admission
                  </Link>
                )}
              </div>
